...
--------------------------------------------------------------------------------
-----         BEGIN AUTOGENERATED DecEq IMPLEMENTATION FOR ValType         -----
--------------------------------------------------------------------------------
||| Auto generated theorem proving injectivity of value constructor IValTp.
||| Generated to assist in proving ivaltp_injective_on_arg0
total ivaltp_injective_on_arg0 : (IValTp x1) = (IValTp x2) -> x1 = x2
ivaltp_injective_on_arg0 Refl = Refl

||| Auto generated theorem proving injectivity of value constructor FValTp.
||| Generated to assist in proving fvaltp_injective_on_arg0
total fvaltp_injective_on_arg0 : (FValTp x1) = (FValTp x2) -> x1 = x2
fvaltp_injective_on_arg0 Refl = Refl

||| Auto generated theorem proving that IValTp is not equal to FValTp.
||| Generated to assist in proving not_IValTp_FValTp
total not_IValTp_FValTp : (IValTp a) = (FValTp z) -> Void
not_IValTp_FValTp Refl impossible

DecEq ValType where
    decEq (IValTp a) (IValTp a') = (case decEq a a' of
        Yes Refl  => Yes Refl
        No contra => No $ \h => (contra . ivaltp_injective_on_arg0) h)
    decEq (IValTp a) (FValTp z) = No not_IValTp_FValTp
    decEq (FValTp a) (IValTp z) = No $ negEqSym not_IValTp_FValTp
    decEq (FValTp a) (FValTp a') = (case decEq a a' of
        Yes Refl  => Yes Refl
        No contra => No $ \h => (contra . fvaltp_injective_on_arg0) h)
--------------------------------------------------------------------------------
-----          END AUTOGENERATED DecEq IMPLEMENTATION FOR ValType          -----
--------------------------------------------------------------------------------
