...
pres {c=Cd [] []} {d=Cd es0 vs0} {t = t} (Step (Cd [] []) (Cd es0 vs0) prf) (HasTp (Cd [] []) t jnil_eq_jt) = 
  let cd_nil_nil_eq_cd_es0_vs0 : (Cd [] [] = Cd es0 vs0) = justInjective prf
      nil_eq_es0 : ([] = es0) = cd_injective_on_arg0 cd_nil_nil_eq_cd_es0_vs0
      nil_eq_vs0 : ([] = vs0) = cd_injective_on_arg1 cd_nil_nil_eq_cd_es0_vs0
      t_is_nil : ([] = t) = justInjective jnil_eq_jt
  in rewrite (sym nil_eq_es0) in 
     rewrite (sym nil_eq_vs0) in HasTp (Cd [] []) t jnil_eq_jt
pres {c=Cd [] (y :: xs)} {d=Cd es0 vs0} {t = t} (Step (Cd [] (y :: xs)) (Cd es0 vs0) prf) (HasTp (Cd [] (y :: xs)) t x) = HasTp (Cd es0 vs0) t ?no_es_some_vs
