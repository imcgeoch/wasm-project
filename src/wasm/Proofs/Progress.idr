...
progress (HasTp i t prf) with (i)
  ...
  progress (HasTp i t prf) 
            | (MkInterp cf (e :: es) vs) with 
              (maybe_to_eq $ step $ MkInterp cf (e :: es) vs)
    progress (HasTp i t prf) 
              | (MkInterp cf (e :: es) vs) 
              | Left (i' ** mi) = 
    ...
    progress (HasTp i t prf) | (MkInterp cf (e :: es) vs) | Right r with (e)
      ...
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
                | (Ins (IBinOp op w)) = case r of Refl impossible
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
                | (Ins Nop) = case r of Refl impossible
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
                | (Ins (Block xs ys)) = case r of Refl impossible
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
      ...
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
                | (AdIns (Label k xs ys ws)) = case r of Refl impossible
      progress (HasTp i t prf) 
                | (MkInterp cf (e :: es) vs) 
                |  Right r 
